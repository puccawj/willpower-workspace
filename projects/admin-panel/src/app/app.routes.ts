  ...
  { path: 'login', component: Login },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: HomeHero,
        canActivate: [roleAccessGuard],
        data: { title: 'Home Hero', subtitle: 'Edit the tagline, heading, description, and stats row on the public-site Home page', allow: ['superadmin'] },
      },
      {
        path: 'home-banners',
        component: HomeBanners,
        canActivate: [roleAccessGuard],
        data: { title: 'Home Banners', subtitle: 'Carousel images shown at the top of the public-site Home page', allow: ['superadmin'] },
      },
      {
        path: 'about-content',
        component: AboutContentPage,
        canActivate: [roleAccessGuard],
        data: { title: 'About Page', subtitle: 'Edit hero text, banner carousel, and the "Our journey" timeline', allow: ['superadmin'] },
      },
      {
        path: 'privacy-policy-content',
        component: PrivacyPolicyContentPage,
        canActivate: [roleAccessGuard],
        data: { title: 'Privacy Policy', subtitle: 'Edit the Privacy Policy shown on the public website', allow: ['superadmin'] },
      },
      {
        path: 'team',
        component: Team,
      ...
      },
      {
        ...
        component: Reports,
        canActivate: [roleAccessGuard],
        data: { title: 'Reports', subtitle: 'Export summaries by branch and time period', allow: ['superadmin'] },
      },
